//SNEAK ATTACK FOR SPELLS by psychospaz
...
const int FEAT_SNEAKATTACK_1 = 221;
const int FEAT_SNEAKATTACK_2 = 345;
const int FEAT_SNEAKATTACK_3 = 346;
const int FEAT_SNEAKATTACK_4 = 347;
const int FEAT_SNEAKATTACK_5 = 348;
const int FEAT_SNEAKATTACK_6 = 349;
const int FEAT_SNEAKATTACK_7 = 350;
const int FEAT_SNEAKATTACK_8 = 351;
const int FEAT_SNEAKATTACK_9 = 352;
const int FEAT_SNEAKATTACK_10 = 353;
const int FEAT_SNEAKATTACK_11 = 1032;
const int FEAT_SNEAKATTACK_12 = 1033;
const int FEAT_SNEAKATTACK_13 = 1034;
const int FEAT_SNEAKATTACK_14 = 1035;
const int FEAT_SNEAKATTACK_15 = 1036;
const int FEAT_SNEAKATTACK_16 = 1037;
const int FEAT_SNEAKATTACK_17 = 1038;
const int FEAT_SNEAKATTACK_18 = 1039;
const int FEAT_SNEAKATTACK_19 = 1040;
const int FEAT_SNEAKATTACK_20 = 1041;
...
int SneakAmount(object oPerson)
{
    ...
    if (GetHasFeat(FEAT_SNEAKATTACK_20, oPerson))
        sneakAmount += 20;
    else if (GetHasFeat(FEAT_SNEAKATTACK_19, oPerson))
        sneakAmount += 19;
    else if (GetHasFeat(FEAT_SNEAKATTACK_18, oPerson))
        sneakAmount += 18;
    else if (GetHasFeat(FEAT_SNEAKATTACK_17, oPerson))
        sneakAmount += 17;
    else if (GetHasFeat(FEAT_SNEAKATTACK_16, oPerson))
        sneakAmount += 16;
    else if (GetHasFeat(FEAT_SNEAKATTACK_15, oPerson))
        sneakAmount += 15;
    else if (GetHasFeat(FEAT_SNEAKATTACK_14, oPerson))
        sneakAmount += 14;
    else if (GetHasFeat(FEAT_SNEAKATTACK_13, oPerson))
        sneakAmount += 13;
    else if (GetHasFeat(FEAT_SNEAKATTACK_12, oPerson))
        sneakAmount += 12;
    else if (GetHasFeat(FEAT_SNEAKATTACK_11, oPerson))
        sneakAmount += 11;
    else if (GetHasFeat(FEAT_SNEAKATTACK_10, oPerson))
        sneakAmount += 10;
    else if (GetHasFeat(FEAT_SNEAKATTACK_9, oPerson))
        sneakAmount += 9;
    else if (GetHasFeat(FEAT_SNEAKATTACK_8, oPerson))
        sneakAmount += 8;
    else if (GetHasFeat(FEAT_SNEAKATTACK_7, oPerson))
        sneakAmount += 7;
    else if (GetHasFeat(FEAT_SNEAKATTACK_6, oPerson))
        sneakAmount += 6;
    else if (GetHasFeat(FEAT_SNEAKATTACK_5, oPerson))
        sneakAmount += 5;
    else if (GetHasFeat(FEAT_SNEAKATTACK_4, oPerson))
        sneakAmount += 4;
    else if (GetHasFeat(FEAT_SNEAKATTACK_3, oPerson))
        sneakAmount += 3;
    else if (GetHasFeat(FEAT_SNEAKATTACK_2, oPerson))
        sneakAmount += 2;
    else if (GetHasFeat(FEAT_SNEAKATTACK_1, oPerson))
        sneakAmount += 1;
...
int CanBeSneaked (object oCaster, object oTarget)
{
    ...
    if (GetObjectSeen(oCaster, oTarget))
    {
        ...
        //is fighting us
        if (GetIsInCombat(oTarget) && (GetAttackTarget(oTarget)==oCaster || GetActionMode(oTarget, ACTION_MODE_COUNTERSPELL)))
            return FALSE;
...
//Returns the sneak attack bonus damage if the target is sneakable!
int getSneakDamage(object oCaster, object oTarget)
{
    if (!CanBeSneaked(oCaster, oTarget))
        return 0;
