...
//--SKIN PART------------------------------------------------------
    ...
    if(sToModify == "SKIN")
    {
        iNewApp = GetColor(OBJECT_SELF, COLOR_CHANNEL_SKIN) - 1;
        if(iNewApp < 0) iNewApp = 175;
        SetColor(OBJECT_SELF, COLOR_CHANNEL_SKIN, iNewApp);
    }
...
//--HAIR PART------------------------------------------------------
    ...
    if(sToModify == "HAIR")
    {
        iNewApp = GetColor(OBJECT_SELF, COLOR_CHANNEL_HAIR) - 1;
        if(iNewApp < 0) iNewApp = 175;
        SetColor(OBJECT_SELF, COLOR_CHANNEL_HAIR, iNewApp);
    }
...
//--TATTOO 1 PART------------------------------------------------------
    ...
    if(sToModify == "TAT1")
    {
        iNewApp = GetColor(OBJECT_SELF, COLOR_CHANNEL_TATTOO_1) - 1;
        if(iNewApp < 0) iNewApp = 175;
        SetColor(OBJECT_SELF, COLOR_CHANNEL_TATTOO_1, iNewApp);
    }
...
//--TATTOO 2 PART------------------------------------------------------
    ...
    if(sToModify == "TAT2")
    {
        iNewApp = GetColor(OBJECT_SELF, COLOR_CHANNEL_TATTOO_2) - 1;
        if(iNewApp < 0) iNewApp = 175;
        SetColor(OBJECT_SELF, COLOR_CHANNEL_TATTOO_2, iNewApp);
    }
