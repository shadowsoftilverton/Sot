...
void main()
{
    if(!GetHasFeatEffect(FEAT_BARBARIAN_RAGE))
    {
        ...
        SetAbilityScore(oPC, ABILITY_STRENGTH, GetAbilityScore(oPC, ABILITY_STRENGTH, TRUE) - iRacialStrMod + 8);
        SetAbilityScore(oPC, ABILITY_CONSTITUTION, GetAbilityScore(oPC, ABILITY_CONSTITUTION, TRUE) - iRacialConMod + 8);
        SetPersistentInt(oPC, "BARBARIAN_RAGING", 1);
        SetPersistentInt(oPC, "BARBARIAN_STR_INC", 8);
        SetPersistentInt(oPC, "BARBARIAN_CON_INC", 8);
