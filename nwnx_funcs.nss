...
// Modifies oCreature's natural base AC by nAC.
void ModifyACNaturalBase(object oCreature, int nAC);
...
// Modifies oPC's remaining skill points.
void ModifyPCSkillPoints(object oPC, int nSkillPoints);
...
void ModifyACNaturalBase(object oCreature, int nAC){
    SetACNaturalBase(oCreature, GetACNaturalBase(oCreature) + nAC);
}
...
void ModifyPCSkillPoints(object oPC, int nSkillPoints){
    int nNew = GetPCSkillPoints(oPC) + nSkillPoints;
    SetPCSkillPoints(oPC, nNew);
}
