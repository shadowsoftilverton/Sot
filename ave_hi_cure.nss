...
// End of Spell Cast Hook
    ...
    int nLevel=996-nSpellID;
    int nClass=Hier_GetClass(oPC);
    int nCheckSpell;

    switch(nLevel)
    {
    case 0: nCheckSpell=33;
    break;
    case 1: nCheckSpell=32;
    break;
    case 2: nCheckSpell=34;
    break;
    case 3: nCheckSpell=35;
    break;
    case 4: nCheckSpell=31;
    break;
    }
...
/*Light*/     case 995: DoRangedCure(nDC,nMetaMagic,d8(1), 5, 8, VFX_IMP_SUNSTRIKE, VFX_IMP_HEAD_HEAL, nSpellID); break;
