...
void main()
{
    ...
    float fDuration = RoundsToSeconds(nHD);
    int nPenal = nHD / 3 + 2;
        ...
        && (oTarget != OBJECT_SELF))
        {
            ...
            && (LineOfSightObject(OBJECT_SELF, oTarget)))
            {
                ...
                if (!MySavingThrow(SAVING_THROW_FORT, oTarget, nDC, SAVING_THROW_TYPE_NONE, OBJECT_SELF))
                {
                    ...
                    eGaze1 = EffectAbilityDecrease(ABILITY_STRENGTH, nPenal);
                    eGaze2 = EffectAbilityDecrease(ABILITY_DEXTERITY, nPenal);
                    eGaze3 = EffectAbilityDecrease(ABILITY_CONSTITUTION, nPenal);
                    eGaze4 = EffectAbilityDecrease(ABILITY_WISDOM, nPenal);
                    eGaze5 = EffectAbilityDecrease(ABILITY_INTELLIGENCE, nPenal);
                    eGaze6 = EffectAbilityDecrease(ABILITY_CHARISMA, nPenal);
