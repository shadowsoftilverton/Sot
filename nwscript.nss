...
//  SILVER MARCHES
//
//  This will always fail to compile. Don't worry about
//  it -- the module will still run normally.
//
//  Any modifications to constants should be done in here.
//  Modify functions in here by renaming the original and
//  making a new function with its name.
//
//  Save the module to a backup before modifying this file.
//  Changes to it can and will cause fatal errors in the
//  toolset. Sometimes these errors cannot be recovered
//  and the only way to salvage the module is reversion or
...
// ** CUSTOM SPELL VARIABLES ** //

int SPELL_ANALYZE_DWEOMER                  = 844;

int SPELLABILITY_RALLYING_PRESENCE   = 1390;
int SPELLABILITY_WARDING_PRESENCE    = 1391;
int SPELLABILITY_FEARLESS_PRESENCE   = 1392;
int SPELLABILITY_TERRIFYING_PRESENCE = 1393;
int SPELLABILITY_WRATHFUL_PRESENCE   = 1394;
int SPELLABILITY_FINAL_STAND         = 1395;

// SYSTEM SPELLS
int SPELL_SYSTEM                           = 1001;
int PARRY_BONUS_SPELL_ID                   = 1138;
int TOUCHING_SPELL_ID                      = 1139;
int PERFECT_SELF_SPELL_ID                  = 1140;
int DIVINE_GRACE_SPELL_ID                  = 1141;
...
int CLASS_TYPE_BATTLECAPTAIN = 41;

int CLASS_TYPE_ARCHMAGE = 51;
int CLASS_TYPE_MYSTIC_THEURGE = 52;
int CLASS_TYPE_ELDRITCH_KNIGHT = 53;
int CLASS_TYPE_TEMPEST = 54;
int CLASS_TYPE_DUELIST = 55;
...
// CUTOFF FOR FOCUS FEATS
int SKILL_RIDE               = 27;
int SKILL_PROFESSION         = 28;
int SKILL_K_NOBILITY         = 29;
int SKILL_K_LOCAL            = 30;
int SKILL_GATHER_INFORMATION = 31;
int SKILL_SENSE_MOTIVE       = 32;
int SKILL_DISGUISE           = 33;
int SKILL_FORGERY            = 34;
int SKILL_ESCAPE_ARTIST      = 35;
int SKILL_DECIPHER_SCRIPT    = 36;
int SKILL_K_ENGINEERING      = 37;
int SKILL_K_DUNGEONEERING    = 38;
int SKILL_K_GEOGRAPHY        = 39;
int SKILL_K_HISTORY          = 40;
int SKILL_K_NATURE           = 41;
int SKILL_K_RELIGION         = 42;
int SKILL_K_PLANES           = 43;
int SKILL_SURVIVAL           = 44;
int SKILL_ATHLETICS          = 45;
int SKILL_STEALTH            = 48;
int SKILL_PERCEPTION         = 49;
...
int FEAT_UTILITY_WAND_SELF                  = 1106;
int FEAT_UTILITY_WAND                       = 1107;
int FEAT_PUPPET_WAND_GENERAL                = 1108;
int FEAT_PUPPET_WAND_RESET                  = 1109;
int FEAT_MODIFICATION_WAND                  = 1110;
int FEAT_DESTRUCTION_WAND                   = 1111;
int FEAT_ENCOUNTER_WAND                     = 1112;

int FEAT_WEAPON_PROFICIENCY_DWARF           = 1120;
int FEAT_NATURAL_SPELL                      = 1121;
int FEAT_AUGMENT_SUMMONING                  = 1122;
int FEAT_SMITE_INFIDEL                      = 1123;

int FEAT_TOWER_SHIELD_PROFICIENCY           = 1129;
int FEAT_IMPROVED_TOWER_SHIELD_PROFICIENCY  = 1130;
int FEAT_GREATER_TOWER_SHIELD_PROFICIENCY   = 1131;

int FEAT_GREATER_TWO_WEAPON_FIGHTING        = 1132;
int FEAT_TWO_WEAPON_DEFENSE                 = 1133;
int  FEAT_IMPROVED_TWO_WEAPON_DEFENSE       = 1134;
int  FEAT_GREATER_TWO_WEAPON_DEFENSE        = 1135;

int FEAT_FLY                                = 1136;

int FEAT_MASTERY_OF_ELEMENTS                = 1137;
int FEAT_MASTERY_OF_SHAPES                  = 1138;
int FEAT_ARCANE_FIRE                        = 1139;
int FEAT_ARCANE_REACH                       = 1140;
int FEAT_MASTERY_OF_COUNTERSPELLING         = 1141;
int FEAT_SPELL_POWER_1                      = 1142;
int FEAT_SPELL_POWER_2                      = 1143;
int FEAT_SPELL_POWER_3                      = 1144;
int FEAT_SPELL_POWER_4                      = 1145;
int FEAT_SPELL_POWER_5                      = 1146;
int FEAT_SPELL_LIKE_ABILITY                 = 1147;

int FEAT_DETECT_EVIL                        = 1148;
int FEAT_DETECT_GOOD                        = 1149;

int FEAT_SKILL_FOCUS_RIDE                   = 1150;
int FEAT_SKILL_FOCUS_K_ARCANA               = 1151;
int FEAT_SKILL_FOCUS_K_NOBILITY             = 1152;
int FEAT_SKILL_FOCUS_K_LOCAL                = 1153;
int FEAT_SKILL_FOCUS_GATHER_INFORMATION     = 1154;
int FEAT_SKILL_FOCUS_SENSE_MOTIVE           = 1155;
int FEAT_SKILL_FOCUS_DISGUISE               = 1156;
int FEAT_SKILL_FOCUS_FORGERY                = 1157;
int FEAT_SKILL_FOCUS_ESCAPE_ARTIST          = 1158;
int FEAT_SKILL_FOCUS_DECIPHER_SCRIPT        = 1159;
int FEAT_SKILL_FOCUS_K_ENGINEERING          = 1160;
int FEAT_SKILL_FOCUS_K_DUNGEONEERING        = 1161;
int FEAT_SKILL_FOCUS_K_GEOGRAPHY            = 1162;
int FEAT_SKILL_FOCUS_K_HISTORY              = 1163;
int FEAT_SKILL_FOCUS_K_NATURE               = 1164;
int FEAT_SKILL_FOCUS_K_RELIGION             = 1165;
int FEAT_SKILL_FOCUS_K_PLANES               = 1166;
int FEAT_SKILL_FOCUS_SURVIVAL               = 1167;

int FEAT_EPIC_SKILL_FOCUS_RIDE                   = 1168;
int FEAT_EPIC_SKILL_FOCUS_K_ARCANA               = 1169;
int FEAT_EPIC_SKILL_FOCUS_K_NOBILITY             = 1170;
int FEAT_EPIC_SKILL_FOCUS_K_LOCAL                = 1171;
int FEAT_EPIC_SKILL_FOCUS_GATHER_INFORMATION     = 1172;
int FEAT_EPIC_SKILL_FOCUS_SENSE_MOTIVE           = 1173;
int FEAT_EPIC_SKILL_FOCUS_DISGUISE               = 1174;
int FEAT_EPIC_SKILL_FOCUS_FORGERY                = 1175;
int FEAT_EPIC_SKILL_FOCUS_ESCAPE_ARTIST          = 1176;
int FEAT_EPIC_SKILL_FOCUS_DECIPHER_SCRIPT        = 1177;
int FEAT_EPIC_SKILL_FOCUS_K_ENGINEERING          = 1178;
int FEAT_EPIC_SKILL_FOCUS_K_DUNGEONEERING        = 1179;
int FEAT_EPIC_SKILL_FOCUS_K_GEOGRAPHY            = 1180;
int FEAT_EPIC_SKILL_FOCUS_K_HISTORY              = 1181;
int FEAT_EPIC_SKILL_FOCUS_K_NATURE               = 1182;
int FEAT_EPIC_SKILL_FOCUS_K_RELIGION             = 1183;
int FEAT_EPIC_SKILL_FOCUS_K_PLANES               = 1184;
int FEAT_EPIC_SKILL_FOCUS_SURVIVAL               = 1185;

int FEAT_PRACTICED_SPELLCASTER_WIZARD       = 1186;
int FEAT_PRACTICED_SPELLCASTER_SORCERER     = 1187;
int FEAT_PRACTICED_SPELLCASTER_BARD         = 1188;
int FEAT_PRACTICED_SPELLCASTER_CLERIC       = 1189;
int FEAT_PRACTICED_SPELLCASTER_DRUID        = 1190;
int FEAT_PRACTICED_SPELLCASTER_PALADIN      = 1191;
int FEAT_PRACTICED_SPELLCASTER_RANGER       = 1192;

int FEAT_POWER_CRITICAL_DAGGER              = 1193;
int FEAT_POWER_CRITICAL_DART                = 1194;
int FEAT_POWER_CRITICAL_HEAVY_CROSSBOW      = 1195;
int FEAT_POWER_CRITICAL_LIGHT_CROSSBOW      = 1196;
int FEAT_POWER_CRITICAL_LIGHT_MACE          = 1197;
int FEAT_POWER_CRITICAL_MORNING_STAR        = 1198;
int FEAT_POWER_CRITICAL_STAFF               = 1199;
int FEAT_POWER_CRITICAL_SPEAR               = 1200;
int FEAT_POWER_CRITICAL_SICKLE              = 1201;
int FEAT_POWER_CRITICAL_SLING               = 1202;
int FEAT_POWER_CRITICAL_UNARMED_STRIKE      = 1203;
int FEAT_POWER_CRITICAL_LONGBOW             = 1204;
int FEAT_POWER_CRITICAL_SHORTBOW            = 1205;
int FEAT_POWER_CRITICAL_SHORT_SWORD         = 1206;
int FEAT_POWER_CRITICAL_RAPIER              = 1207;
int FEAT_POWER_CRITICAL_SCIMITAR            = 1208;
int FEAT_POWER_CRITICAL_LONG_SWORD          = 1209;
int FEAT_POWER_CRITICAL_GREAT_SWORD         = 1210;
int FEAT_POWER_CRITICAL_HAND_AXE            = 1211;
int FEAT_POWER_CRITICAL_THROWING_AXE        = 1212;
int FEAT_POWER_CRITICAL_BATTLE_AXE          = 1213;
int FEAT_POWER_CRITICAL_GREAT_AXE           = 1214;
int FEAT_POWER_CRITICAL_HALBERD             = 1215;
int FEAT_POWER_CRITICAL_LIGHT_HAMMER        = 1216;
int FEAT_POWER_CRITICAL_LIGHT_FLAIL         = 1217;
int FEAT_POWER_CRITICAL_WAR_HAMMER          = 1218;
int FEAT_POWER_CRITICAL_HEAVY_FLAIL         = 1219;
int FEAT_POWER_CRITICAL_KAMA                = 1220;
int FEAT_POWER_CRITICAL_KUKRI               = 1221;
int FEAT_POWER_CRITICAL_SHURIKEN            = 1222;
int FEAT_POWER_CRITICAL_SCYTHE              = 1223;
int FEAT_POWER_CRITICAL_KATANA              = 1224;
int FEAT_POWER_CRITICAL_BASTARD_SWORD       = 1225;
int FEAT_POWER_CRITICAL_DIRE_MACE           = 1226;
int FEAT_POWER_CRITICAL_DOUBLE_AXE          = 1227;
int FEAT_POWER_CRITICAL_TWO_BLADED_SWORD    = 1228;

int FEAT_GREATER_WEAPON_FOCUS_DAGGER            = 1229;
int FEAT_GREATER_WEAPON_FOCUS_DART              = 1230;
int FEAT_GREATER_WEAPON_FOCUS_HEAVY_CROSSBOW    = 1231;
int FEAT_GREATER_WEAPON_FOCUS_LIGHT_CROSSBOW    = 1232;
int FEAT_GREATER_WEAPON_FOCUS_LIGHT_MACE        = 1233;
int FEAT_GREATER_WEAPON_FOCUS_MORNING_STAR      = 1234;
int FEAT_GREATER_WEAPON_FOCUS_STAFF             = 1235;
int FEAT_GREATER_WEAPON_FOCUS_SPEAR             = 1236;
int FEAT_GREATER_WEAPON_FOCUS_SICKLE            = 1237;
int FEAT_GREATER_WEAPON_FOCUS_SLING             = 1238;
int FEAT_GREATER_WEAPON_FOCUS_UNARMED_STRIKE    = 1239;
int FEAT_GREATER_WEAPON_FOCUS_LONGBOW           = 1240;
int FEAT_GREATER_WEAPON_FOCUS_SHORTBOW          = 1241;
int FEAT_GREATER_WEAPON_FOCUS_SHORT_SWORD       = 1242;
int FEAT_GREATER_WEAPON_FOCUS_RAPIER            = 1243;
int FEAT_GREATER_WEAPON_FOCUS_SCIMITAR          = 1244;
int FEAT_GREATER_WEAPON_FOCUS_LONG_SWORD        = 1245;
int FEAT_GREATER_WEAPON_FOCUS_GREAT_SWORD       = 1246;
int FEAT_GREATER_WEAPON_FOCUS_HAND_AXE          = 1247;
int FEAT_GREATER_WEAPON_FOCUS_THROWING_AXE      = 1248;
int FEAT_GREATER_WEAPON_FOCUS_BATTLE_AXE        = 1249;
int FEAT_GREATER_WEAPON_FOCUS_GREAT_AXE         = 1250;
int FEAT_GREATER_WEAPON_FOCUS_HALBERD           = 1251;
int FEAT_GREATER_WEAPON_FOCUS_LIGHT_HAMMER      = 1252;
int FEAT_GREATER_WEAPON_FOCUS_LIGHT_FLAIL       = 1253;
int FEAT_GREATER_WEAPON_FOCUS_WAR_HAMMER        = 1254;
int FEAT_GREATER_WEAPON_FOCUS_HEAVY_FLAIL       = 1255;
int FEAT_GREATER_WEAPON_FOCUS_KAMA              = 1256;
int FEAT_GREATER_WEAPON_FOCUS_KUKRI             = 1257;
int FEAT_GREATER_WEAPON_FOCUS_SHURIKEN          = 1258;
int FEAT_GREATER_WEAPON_FOCUS_SCYTHE            = 1259;
int FEAT_GREATER_WEAPON_FOCUS_KATANA            = 1260;
int FEAT_GREATER_WEAPON_FOCUS_BASTARD_SWORD     = 1261;
int FEAT_GREATER_WEAPON_FOCUS_DIRE_MACE         = 1262;
int FEAT_GREATER_WEAPON_FOCUS_DOUBLE_AXE        = 1263;
int FEAT_GREATER_WEAPON_FOCUS_TWO_BLADED_SWORD  = 1264;

int FEAT_IMPROVED_POWER_CRITICAL_DAGGER              = 1193;
int FEAT_IMPROVED_POWER_CRITICAL_DART                = 1194;
int FEAT_IMPROVED_POWER_CRITICAL_HEAVY_CROSSBOW      = 1195;
int FEAT_IMPROVED_POWER_CRITICAL_LIGHT_CROSSBOW      = 1196;
int FEAT_IMPROVED_POWER_CRITICAL_LIGHT_MACE          = 1197;
int FEAT_IMPROVED_POWER_CRITICAL_MORNING_STAR        = 1198;
int FEAT_IMPROVED_POWER_CRITICAL_STAFF               = 1199;
int FEAT_IMPROVED_POWER_CRITICAL_SPEAR               = 1200;
int FEAT_IMPROVED_POWER_CRITICAL_SICKLE              = 1201;
int FEAT_IMPROVED_POWER_CRITICAL_SLING               = 1202;
int FEAT_IMPROVED_POWER_CRITICAL_UNARMED_STRIKE      = 1203;
int FEAT_IMPROVED_POWER_CRITICAL_LONGBOW             = 1204;
int FEAT_IMPROVED_POWER_CRITICAL_SHORTBOW            = 1205;
int FEAT_IMPROVED_POWER_CRITICAL_SHORT_SWORD         = 1206;
int FEAT_IMPROVED_POWER_CRITICAL_RAPIER              = 1207;
int FEAT_IMPROVED_POWER_CRITICAL_SCIMITAR            = 1208;
int FEAT_IMPROVED_POWER_CRITICAL_LONG_SWORD          = 1209;
int FEAT_IMPROVED_POWER_CRITICAL_GREAT_SWORD         = 1210;
int FEAT_IMPROVED_POWER_CRITICAL_HAND_AXE            = 1211;
int FEAT_IMPROVED_POWER_CRITICAL_THROWING_AXE        = 1212;
int FEAT_IMPROVED_POWER_CRITICAL_BATTLE_AXE          = 1213;
int FEAT_IMPROVED_POWER_CRITICAL_GREAT_AXE           = 1214;
int FEAT_IMPROVED_POWER_CRITICAL_HALBERD             = 1215;
int FEAT_IMPROVED_POWER_CRITICAL_LIGHT_HAMMER        = 1216;
int FEAT_IMPROVED_POWER_CRITICAL_LIGHT_FLAIL         = 1217;
int FEAT_IMPROVED_POWER_CRITICAL_WAR_HAMMER          = 1218;
int FEAT_IMPROVED_POWER_CRITICAL_HEAVY_FLAIL         = 1219;
int FEAT_IMPROVED_POWER_CRITICAL_KAMA                = 1220;
int FEAT_IMPROVED_POWER_CRITICAL_KUKRI               = 1221;
int FEAT_IMPROVED_POWER_CRITICAL_SHURIKEN            = 1222;
int FEAT_IMPROVED_POWER_CRITICAL_SCYTHE              = 1223;
int FEAT_IMPROVED_POWER_CRITICAL_KATANA              = 1224;
int FEAT_IMPROVED_POWER_CRITICAL_BASTARD_SWORD       = 1225;
int FEAT_IMPROVED_POWER_CRITICAL_DIRE_MACE           = 1226;
int FEAT_IMPROVED_POWER_CRITICAL_DOUBLE_AXE          = 1227;
int FEAT_IMPROVED_POWER_CRITICAL_TWO_BLADED_SWORD    = 1228;

int FEAT_SOT_POWER_ATTACK          = 1304;
int FEAT_SOT_IMPROVED_POWER_ATTACK = 1305;

int FEAT_SOT_EXPERTISE          = 1306;
int FEAT_SOT_IMPROVED_EXPERTISE = 1307;
...
int FEAT_FOCUSED_ATTACK          = 1317;
int FEAT_IMPROVED_FOCUSED_ATTACK = 1318;

int FEAT_LANGUAGE_COMMON       = 1400;
int FEAT_LANGUAGE_UNDERCOMMON  = 1401;
int FEAT_LANGUAGE_AQUAN        = 1402;
int FEAT_LANGUAGE_AURAN        = 1403;
int FEAT_LANGUAGE_GIANT        = 1404;
int FEAT_LANGUAGE_GNOLL        = 1405;
int FEAT_LANGUAGE_IGNAN        = 1406;
int FEAT_LANGUAGE_SYLVAN       = 1407;
int FEAT_LANGUAGE_TERRAN       = 1408;
int FEAT_LANGUAGE_TREANT       = 1409;
int FEAT_LANGUAGE_ALGARONDAN   = 1410;
int FEAT_LANGUAGE_ALZHEDO      = 1411;
int FEAT_LANGUAGE_CHESSENTAN   = 1412;
int FEAT_LANGUAGE_CHONDATHAN   = 1413;
int FEAT_LANGUAGE_CHULTAN      = 1414;
int FEAT_LANGUAGE_DAMARAN      = 1415;
int FEAT_LANGUAGE_DAMBRATHAN   = 1416;
int FEAT_LANGUAGE_DURPARI      = 1417;
int FEAT_LANGUAGE_HALARDRIM    = 1418;
int FEAT_LANGUAGE_HALRUAAN     = 1419;
int FEAT_LANGUAGE_ILLUSKAN     = 1420;
int FEAT_LANGUAGE_IMASKAR      = 1421;
int FEAT_LANGUAGE_LANTANESE    = 1422;
int FEAT_LANGUAGE_MIDANI       = 1423;
int FEAT_LANGUAGE_MULHORANDI   = 1424;
int FEAT_LANGUAGE_NEXALAN      = 1425;
int FEAT_LANGUAGE_OILLUSK      = 1426;
int FEAT_LANGUAGE_RASHEMI      = 1427;
int FEAT_LANGUAGE_RAUMVIRA     = 1428;
int FEAT_LANGUAGE_SERUSAN      = 1429;
int FEAT_LANGUAGE_SHAARAN      = 1430;
int FEAT_LANGUAGE_SHOU         = 1431;
int FEAT_LANGUAGE_TALFIRIC     = 1432;
int FEAT_LANGUAGE_TASHALAN     = 1433;
int FEAT_LANGUAGE_TUIGAN       = 1434;
int FEAT_LANGUAGE_TURMIC       = 1435;
int FEAT_LANGUAGE_ULUIK        = 1436;
int FEAT_LANGUAGE_UNTHERIC     = 1437;
int FEAT_LANGUAGE_VAASAN       = 1438;
int FEAT_LANGUAGE_DRUIDIC      = 1439;
int FEAT_LANGUAGE_ASSASSIN     = 1440;
int FEAT_LANGUAGE_TROLL        = 1441;
int FEAT_LANGUAGE_THRIKREEN    = 1442;
int FEAT_LANGUAGE_GRIMLOCK     = 1443;
int FEAT_LANGUAGE_KUOTOAN      = 1444;
int FEAT_LANGUAGE_MINOTAUR     = 1445;
int FEAT_LANGUAGE_RAKSHASA     = 1446;
int FEAT_LANGUAGE_STINGER      = 1447;
int FEAT_LANGUAGE_LIZARDMAN    = 1448;
int FEAT_LANGUAGE_ILLITHID     = 1449;
int FEAT_LANGUAGE_HOBGOBLIN    = 1450;
int FEAT_LANGUAGE_DUERGAR      = 1451;
int FEAT_LANGUAGE_BUGBEAR      = 1452;
int FEAT_LANGUAGE_GITHZERAI    = 1453;
int FEAT_LANGUAGE_KORRED       = 1454;
int FEAT_LANGUAGE_SAHAGUIN     = 1455;
int FEAT_LANGUAGE_YUANTI       = 1456;
int FEAT_LANGUAGE_PIXIE        = 1457;
int FEAT_LANGUAGE_HENGEYOKAI   = 1458;
int FEAT_LANGUAGE_SVIRFNEBLIN  = 1459;
int FEAT_LANGUAGE_HIGH_SHOU    = 1460;
int FEAT_LANGUAGE_AVERIAL      = 1461;
int FEAT_LANGUAGE_KOBOLD       = 1462;
int FEAT_LANGUAGE_OGRE         = 1463;
int FEAT_LANGUAGE_DROW         = 1464;
int FEAT_LANGUAGE_INFERNAL     = 1465;
int FEAT_LANGUAGE_ABYSSAL      = 1466;
int FEAT_LANGUAGE_CELESTIAL    = 1467;
int FEAT_LANGUAGE_GOBLIN       = 1468;
int FEAT_LANGUAGE_DRACONIC     = 1469;
int FEAT_LANGUAGE_DWARVEN      = 1470;
int FEAT_LANGUAGE_ELVEN        = 1471;
int FEAT_LANGUAGE_GNOMISH      = 1472;
int FEAT_LANGUAGE_HALFLING     = 1473;
int FEAT_LANGUAGE_ORCISH       = 1474;
int FEAT_LANGUAGE_CANT         = 1475;
int FEAT_LANGUAGE_DROW_SIGN    = 1476;

int FEAT_SOT_PERFECT_SELF = 1638;
int FEAT_SOT_DIVINE_GRACE = 1639;

int FEAT_CORPSE_CRAFTER          = 1640;
int FEAT_BOLSTER_RESISTANCE      = 1641;
int FEAT_DEADLY_CHILL            = 1642;
int FEAT_DESTRUCTION_RETRIBUTION = 1643;
int FEAT_HARDENED_FLESH          = 1644;
int FEAT_NIMBLE_BONES            = 1645;

int FEAT_SOT_DEFENSIVE_STANCE = 1646;

int FEAT_POLEARM_DEFENSE = 1667;
...
// SMS Looping Animation Constants

int ANIMATION_LOOPING_DEAD_SIDE     = -1;
int ANIMATION_LOOPING_CROUCH        = -1;
int ANIMATION_LOOPING_BECKON        = -1;
int ANIMATION_LOOPING_CROSS_ARMS    = -1;
int ANIMATION_LOOPING_POINT         = -1;
int ANIMATION_LOOPING_THOUGHTFUL    = -1;
int ANIMATION_LOOPING_COWER         = -1;
...
// ** ADDITIONAL CONSTANTS FOR SILVER MARCHES ** //

// Different weapon damage types.
int WEAPON_DAMAGE_TYPE_INVALID = 0;
int WEAPON_DAMAGE_TYPE_PIERCING = 1;
int WEAPON_DAMAGE_TYPE_BLUDGEONING = 2;
int WEAPON_DAMAGE_TYPE_SLASHING = 3;
int WEAPON_DAMAGE_TYPE_PIERCING_SLASHING = 4;
int WEAPON_DAMAGE_TYPE_BLUDGEONING_PIERCING = 5;

// Pre-defined colors.
string COLOR_WHITE      = "<cþþþ>";
string COLOR_RED        = "<cþ<<>";
string COLOR_RED2       = "<cþ>"; //fire damage
string COLOR_GREEN      = "<c þ >"; //tells - acid
string COLOR_LT_GREEN   = "<c´þd>";
string COLOR_BLUE       = "<c!}þ>";  //electrical damage
string COLOR_LT_BLUE    = "<cßþ>"; //dm channel
string COLOR_LT_BLUE2   = "<c›þþ>"; //cold damage
string COLOR_MAGENTA    = "<cþ þ>";
string COLOR_YELLOW     = "<cþþ>"; //send message to pc default (server messages)
string COLOR_CYAN       = "<c þþ>";
string COLOR_PURPLE     = "<cþ>"; //names
string COLOR_LT_PURPLE  = "<cÍþ>";
string COLOR_ORANGE     = "<cþ–2>";
string COLOR_GOLD       = "<cþïP>"; //shouts

string NEWLINE = "\n";

// System colors for emulation of checks.
string COLOR_NAME = "<c™þþ>";
string COLOR_SKILL_CHECK = "<c fþ>";
string COLOR_SAVE = "<cfÌþ>";
...
// OLD: int GetCasterLevel(object oCreature);
int Std_GetCasterLevel(object oCreature);
...
// * No return value
void Std_RemoveEffect(object oCreature, effect eEffect);
...
// OLD: int FortitudeSave(object oCreature, int nDC, int nSaveType=SAVING_THROW_TYPE_NONE, object oSaveVersus=OBJECT_SELF);
int Std_FortitudeSave(object oCreature, int nDC, int nSaveType=SAVING_THROW_TYPE_NONE, object oSaveVersus=OBJECT_SELF);
...
// Note: If used within an Area of Effect Object Script (On Enter, OnExit, OnHeartbeat), you MUST pass
// GetAreaOfEffectCreator() into oSaveVersus!!
// OLD: int ReflexSave(object oCreature, int nDC, int nSaveType=SAVING_THROW_TYPE_NONE, object oSaveVersus=OBJECT_SELF);
int Std_ReflexSave(object oCreature, int nDC, int nSaveType=SAVING_THROW_TYPE_NONE, object oSaveVersus=OBJECT_SELF);
...
// Note: If used within an Area of Effect Object Script (On Enter, OnExit, OnHeartbeat), you MUST pass
// GetAreaOfEffectCreator() into oSaveVersus!!
// OLD: int WillSave(object oCreature, int nDC, int nSaveType=SAVING_THROW_TYPE_NONE, object oSaveVersus=OBJECT_SELF);
int Std_WillSave(object oCreature, int nDC, int nSaveType=SAVING_THROW_TYPE_NONE, object oSaveVersus=OBJECT_SELF);
...
// OLD: int GetSpellSaveDC();
int Std_GetSpellSaveDC();
...
int Std_TouchAttackMelee(object oTarget, int bDisplayFeedback=TRUE);

// The caller will perform a Ranged Touch Attack on oTarget
// * Returns 0 on a miss, 1 on a hit and 2 on a critical hit
//int TouchAttackRanged(object oTarget, int bDisplayFeedback=TRUE);
int Std_TouchAttackRanged(object oTarget, int bDisplayFeedback=TRUE);
...
// OLD: int GetSkillRank(int nSkill, object oTarget=OBJECT_SELF, int nBaseSkillRank=FALSE);
int Std_GetSkillRank(int nSkill, object oTarget=OBJECT_SELF, int nBaseSkillRank=FALSE);
...
void Std_RemoveItemProperty(object oItem, itemproperty ipProperty);
...
// OLD: int GetIsSkillSuccessful(object oTarget, int nSkill, int nDifficulty);
int Std_GetIsSkillSuccessful(object oTarget, int nSkill, int nDifficulty);
