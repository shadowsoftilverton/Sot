//:://////////////////////////////////////////////////
//:: nessasecretdoor2
//:: modeled from X0_I0_SECRET
//:: edited by tasteslikepurple
//:: changes: checks for SNHouseKey and rolls search
//   so basically, if search check fails, the script
//   checks if the PC has the SNHouseKey and reveals if
//   it does. IMPORTANT: SEARCH CHECK STILL OCCURS!
                     ...
                     int nSkillType=SKILL_SEARCH)
{
    ...
    int nMod = d20();
    int SNkey= HasItemByTag(oPC,"SNHouseKey");
