...
// End of Spell Cast Hook
    ...
    RemoveSpellEffects(SPELL_EAGLE_SPLEDOR, OBJECT_SELF, oTarget);
    RemoveSpellEffects(SPELL_GREATER_EAGLE_SPLENDOR, OBJECT_SELF, oTarget);
