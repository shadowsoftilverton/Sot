//Elemental Weapon (Frost) by Hardcore UFO
//Will apply scaling cold damage based on level to a weapon as a temporary property.
...
void main()
{
    ...
    itemproperty iGlow = ItemPropertyVisualEffect(ITEM_VISUAL_COLD);
