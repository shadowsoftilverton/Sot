...
//--PUT ON SKIN------------------------------------------------
    if(sToModify == "SKIN")
    {
        int iSkin = GetColor(OBJECT_SELF, COLOR_CHANNEL_SKIN);
...
//--PUT ON HAIR------------------------------------------------
    if(sToModify == "HAIR")
    {
        int iHair = GetColor(OBJECT_SELF, COLOR_CHANNEL_HAIR);
...
//--PUT ON TATTOO 1------------------------------------------------
    if(sToModify == "TAT1")
    {
        int iTat = GetColor(OBJECT_SELF, COLOR_CHANNEL_TATTOO_1);
        SetColor(oPC, COLOR_CHANNEL_TATTOO_1, iTat);
        return;
    }
...
//--PUT ON TATTOO 2------------------------------------------------
    if(sToModify == "TAT2")
    {
        int iTat = GetColor(OBJECT_SELF, COLOR_CHANNEL_TATTOO_2);
        SetColor(oPC, COLOR_CHANNEL_TATTOO_2, iTat);
        return;
    }
}
