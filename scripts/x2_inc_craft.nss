...
int CICraftCheckBrewPotion(object oSpellTarget, object oCaster)
{
    ...
    float nExperienceCost = 15.0 * nLevel; // Invictus - 1-5-2012
    int nGoldCost = nCost ;
...
int CICraftCheckScribeScroll(object oSpellTarget, object oCaster)
{
    ...
    SendMessageToPC(oCaster,"The Bioware scroll scribing mechanic has been replaced "+
    "by a custom tutoring system in Shadows of Tilverton, using the demonstrate spell "+
    "and observe spell feats. If you are a nonwizard who has taken the scribe scroll "+
    "feat, you can exchange it with a relevel or a LETO");
    return FALSE;
    ...
    float fExperienceCost = 100.0 * nLevel;   // Invictus - 1-5-2012
    int nGoldCost = nCost ;
...
int CICraftCheckCraftWand(object oSpellTarget, object oCaster)
{
    ...
    float nExperienceCost = 30.0 * nLevel; // Invictus - 1-5-2012
    int nGoldCost = nCost;
