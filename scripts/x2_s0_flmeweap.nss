//Elemental Weapon (Flame) by Hardcore UFO
...
//THIS SCRIPT IS OBSOLETE! Use x2_s0_fireweap instead - Ave
...
void main()
{
    ...
    itemproperty iGlow = ItemPropertyVisualEffect(ITEM_VISUAL_FIRE);
