...
void main()
{
    ...
    effect eFlame = EffectVisualEffect(VFX_IMP_SUPER_HEROISM);
    effect eDur = EffectVisualEffect(VFX_DUR_CESSATE_POSITIVE);
    itemproperty iGlow = ItemPropertyVisualEffect(ITEM_VISUAL_HOLY);
    ...
    itemproperty iDamage = ItemPropertyDamageBonus(IP_CONST_DAMAGETYPE_FIRE, nDamage);
    itemproperty iDamage2 = ItemPropertyDamageBonus(IP_CONST_DAMAGETYPE_POSITIVE, nDamage2);
