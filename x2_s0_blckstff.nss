...
void AddBlackStaffEffectOnWeapon (object oTarget, float fDuration)
{
   ...
   IPSafeAddItemProperty(oTarget, ItemPropertyDamageBonus(IP_CONST_DAMAGETYPE_MAGICAL, IP_CONST_DAMAGEBONUS_1d6), fDuration, X2_IP_ADDPROP_POLICY_REPLACE_EXISTING, FALSE, TRUE);
   IPSafeAddItemProperty(oTarget, ItemPropertyOnHitProps(IP_CONST_ONHIT_DISPELMAGIC, IP_CONST_ONHIT_SAVEDC_24), fDuration,X2_IP_ADDPROP_POLICY_REPLACE_EXISTING );
...
void main()
{
    ...
    */
    ...
    int nMyWeapon = GetBaseItemType(oMyWeapon);
    ...
    if (nMyWeapon == BASE_ITEM_QUARTERSTAFF || nMyWeapon == BASE_ITEM_DIREMACE)
    {
        ...
        AddBlackStaffEffectOnWeapon(oMyWeapon, TurnsToSeconds(nDuration));
    }
