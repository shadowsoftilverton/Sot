...
// End of Spell Cast Hook
    ...
    int iDamageType = GetSpellDamageType(OBJECT_SELF, DAMAGE_TYPE_FIRE);
    ...
    switch(iDamageType){
        ...
        case DAMAGE_TYPE_COLD:
            eExplode = EffectVisualEffect(VFX_FNF_MYSTICAL_EXPLOSION);
            eVis = EffectVisualEffect(VFX_IMP_FROST_L);
        break;

        case DAMAGE_TYPE_ACID:
            eExplode = EffectVisualEffect(VFX_IMP_PULSE_NATURE);
            eVis = EffectVisualEffect(VFX_IMP_ACID_L);
        break;

        case DAMAGE_TYPE_ELECTRICAL:
            eExplode = EffectVisualEffect(VFX_FNF_ELECTRIC_EXPLOSION);
    ...
    if(iDamageType == DAMAGE_TYPE_ACID){
        eExplode = EffectVisualEffect(VFX_FNF_GAS_EXPLOSION_ACID);
        ApplyEffectAtLocation(DURATION_TYPE_INSTANT, eExplode, lTarget);
    }
