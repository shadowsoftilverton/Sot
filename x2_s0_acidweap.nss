//Elemental Weapon (Acid) by Hardcore UFO
//Will apply scaling acid damage based on level to a weapon as a temporary property.
...
void main()
{
    ...
    effect eFlame = EffectVisualEffect(VFX_IMP_ACID_S);
    effect eDur = EffectVisualEffect(VFX_DUR_CESSATE_POSITIVE);
    itemproperty iGlow = ItemPropertyVisualEffect(ITEM_VISUAL_ACID);
    ...
    itemproperty iDamage = ItemPropertyDamageBonus(IP_CONST_DAMAGETYPE_ACID, nDamage);
