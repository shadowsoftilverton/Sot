...
if (iWinningSpot == 51 || iWinningSpot == 52)
    {
    ActionSpeakString("It stopped on the 20 spot. You Win!");
    GiveGoldToCreature(GetPCSpeaker(),iBet*21);
    }
...
if (iWinningSpot == 54)
    {
    ActionSpeakString("It stopped on the Casino Bertix spot. Sorry, you lose.");
    }
}
