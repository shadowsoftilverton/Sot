...
void main()
{
  ...
  if (nRow ==0)
  {
   ...
   IPSafeAddItemProperty(oTarget, ip, IntToFloat(600 * GetLevelByClass(CLASS_TYPE_ASSASSIN, oPC) * nDuration), X2_IP_ADDPROP_POLICY_KEEP_EXISTING, TRUE, TRUE);
   ...
   if (IPGetItemHasItemOnHitPropertySubType(oTarget, 19))
   {
       ...
       IPSafeAddItemProperty(oTarget, ItemPropertyVisualEffect(ITEM_VISUAL_ACID), IntToFloat(600 * GetLevelByClass(CLASS_TYPE_ASSASSIN, oPC) * nDuration), X2_IP_ADDPROP_POLICY_KEEP_EXISTING, TRUE, FALSE);
